def get_first_host_split_bin(network_split_bin, mask_cidr):
    first_host_split_bin = network_split_bin
    ...
    while start_split <= 3:
        ...
        first_host_split_bin[start_split] = replacing_split_part
        replacing_split_part = ""
        start_split += 1

    return first_host_split_bin
